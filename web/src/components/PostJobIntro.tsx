...
export default function PostJobIntro() {
  return (
    <div className="bg-white/80 backdrop-blur-md p-8 lg:p-10 rounded-[2.5rem] shadow-sm border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center group cursor-pointer">
