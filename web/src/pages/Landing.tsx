        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <button 
              ...
              className="group inline-flex items-center justify-center gap-2 bg-domestic-red text-white px-8 py-4 rounded-full font-bold text-lg shadow-red-glow hover:bg-red-600 transition-all active:scale-95"
            >
              Hemen Keşfet
